import {
  ...
  CCLITE_DEFAULT_DEVICE_LAYOUT as CCLITE_DEFAULT_DEVICE_LAYOUT_FROM_LIB,
  DeviceLayout,
...
export const CCLITE_DEFAULT_DEVICE_LAYOUT: DeviceLayout = {
  ...CCLITE_DEFAULT_DEVICE_LAYOUT_FROM_LIB,
  id: "cclite",
  name: "CCLite Default",
};
...
export const LITE_PRESET_DEVICE_LAYOUTS: DeviceLayout[] = [
