...
After installation, click the extension icon to open an option page, where you can import a device layout file, choose which device layout to display, and toggle the thumb-3 switch, and choose an OS keyboard layout.
